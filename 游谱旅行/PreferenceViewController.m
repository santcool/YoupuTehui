...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (cell == nil) {
        ...
        [cell.image setImage:[UIImage imageNamed:@"未选框"]];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    ConditionTableViewCell * cell = (ConditionTableViewCell *)[tableView cellForRowAtIndexPath:indexPath];
    [cell.image setImage:[UIImage imageNamed:@"选中钩钩"]];
...
-(void)tableView:(UITableView *)tableView didDeselectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NSString * idString = [nameDic objectForKey:@"value"];
    NSString * qqq = [nameDic objectForKey:@"id"];
    [_array removeObject:idString];
    [_idArray removeObject:qqq];
}
