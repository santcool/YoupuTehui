...
static TravelDaysViewController * days = nil;

@interface TravelDaysViewController ()
{
...
@implementation TravelDaysViewController
...
+(id)shareSingle{
    ...
    dispatch_once (&onceToken, ^{
        ...
        days = [[self alloc]initWithNibName:nil bundle:nil];
...
-(void)createTable{
    ...
    self.travelTable = [[UITableView alloc] initWithFrame:CGRectMake(0, 40, self.view.frame.size.width, [UIScreen mainScreen].bounds.size.height-40) style:UITableViewStylePlain];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (cell == nil) {
        ...
        if ([[nameDic objectForKey:@"value"]isEqualToString:_dayStr]) {
            _lastpath = indexPath;
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [self.delegate travelId:[nameDic objectForKey:@"id"]];
