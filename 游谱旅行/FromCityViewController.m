...
-(void)createTable{
    ...
    self.destinationTable = [[UITableView alloc] initWithFrame:CGRectMake(0, 40, self.view.frame.size.width, [UIScreen mainScreen].bounds.size.height-104) style:UITableViewStylePlain];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    _fromcityStr = strings;
    [self.delegate fromCity:string];
    [self.delegate fromName:_fromcityStr];
