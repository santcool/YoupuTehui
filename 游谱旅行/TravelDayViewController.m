...
-(void)backActon{
    ...
    if ([_titleStr isEqualToString:@"天数"]) {
        [self.delegate travelColor:[UIColor colorWithRed:153/255.0 green:153/255.0 blue:153/255.0 alpha:1]];
    }else{
...
-(void)createTable{
    ...
    self.travelTable = [[UITableView alloc] initWithFrame:CGRectMake(0, 40, 320, [UIScreen mainScreen].bounds.size.height-104) style:UITableViewStylePlain];
